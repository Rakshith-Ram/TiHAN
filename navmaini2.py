...
def calc_velocity():
    ...
    velocity_brake = max(0, (100 - 70 * math.exp(-0.23 * (obstacle_distance - 3.5))))
...
def calc_control_effort():
    ...
    control_effort = 1800 + abs(steering_output) * 60
...
waypoints = extract_waypoints_from_file("/home/infy/cc_route_1/cc_to_ex.txt")
...
'''
note:
1. Speed bumps, intermediate stops added
2. Paste waypoint file path in line 150
3. Start from intermediate points - Working
Rakshith [8-2-24]
'''
